...
with open('/nvme2n1/YangYJworks/@VulApiAlarm/zRealRQ4/pre_train.json', 'r') as f:
    trains = json.load(f)
with open('/nvme2n1/YangYJworks/@VulApiAlarm/VulLibMiner/myData/test.json', 'r') as f:
    tests = json.load(f)

oskg_folder = '/nvme2n1/YangYJworks/@VulApiAlarm/zRQ3_200/'
...
pros_path = os.path.join(oskg_folder, 'huawei-maven-200.csv')
...
output_dir = '/nvme2n1/YangYJworks/@VulApiAlarm/zRQ3_200/huawei'
